...
interface ThirdStatusProps {
  taskList: React.ReactNode;
}

const ThirdStatus: React.FC<ThirdStatusProps> = ({ taskList }) => {
  return (
    <TodoContext.Provider value={true}>
      <div className="flex flex-col w-60 rounded-md bg-purple-400 border-purple-500 border-t-4 p-2 px-2 z-20">
        <div className="mb-5 flex flex-row items-center gap-2">
          ...
          <h1 className="text-xl text-white">Review</h1>
        </div>
