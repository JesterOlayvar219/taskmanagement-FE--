...
interface SecondStatusProps {
  taskList:React.ReactNode;
}

const SecondStatus: React.FC<SecondStatusProps> = ({ taskList }) => {
  return (
    <TodoContext.Provider value={true}>
      <div className="flex flex-col w-60 border-orange-500 border-t-4 rounded-md bg-orange-400 p-2 px-2 z-20">
