...
interface InitialStatusProps {
  taskList: React.ReactNode;
}

const InitialStatus:React.FC<InitialStatusProps> = ({ taskList }) => {
  return (
    <TodoContext.Provider value={true}>
      <div className="flex flex-col w-60 border-t-4 border-sky-500 rounded-md bg-sky-400 p-2 px-2 z-20">
