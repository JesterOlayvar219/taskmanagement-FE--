...
const FinalStatus: React.FC<FinalStatusProps> = ({ taskList }) => {
  return (
    <TodoContext.Provider value={false}>
      <div className="flex flex-col w-60 rounded-md bg-emerald-400 border-emerald-500 border-t-4 p-2 px-2 z-20">
